...
public interface ShopRenderUtils {
    ...
    static void renderShopWarns(AngledShopBlockRenderer.AngledShopEntityRenderState renderState, @NonNull PoseStack poseStack, @NonNull SubmitNodeCollector nodeCollector, @NonNull CameraRenderState cameraRenderState, BlockEntityRendererProvider.Context context, float yOffset) {
        renderShopWarns(renderState, poseStack, nodeCollector, cameraRenderState, context, yOffset, 0.5f);
    }

    static void renderShopWarns(
            AngledShopBlockRenderer.AngledShopEntityRenderState data, @NonNull PoseStack matrices,
            @NonNull SubmitNodeCollector nodeCollector, @NonNull CameraRenderState cameraRenderState,
            BlockEntityRendererProvider.Context context, float yOffset, float scale) {
