...
public class AngledShopBlockRenderer implements BlockEntityRenderer<AngledShopEntity, AngledShopBlockRenderer.AngledShopEntityRenderState> {
    ...
    public void extractRenderState(
        ...
        renderState.stockQuantity = context.font().split(FormattedText.of(data.stockQuantity), 1).getFirst();
        renderState.priceQuantity = context.font().split(FormattedText.of(data.priceQuantity), 1).getFirst();

        ModelPart mp = context.bakeLayer(CushionModel.LAYER_LOCATION);
